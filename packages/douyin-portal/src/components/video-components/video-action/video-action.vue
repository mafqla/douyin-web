...
<template>
  <div class="video-action" :style="{ transform: `scale(${scale})`, transformOrigin: 'center bottom' }">
    <slot />
    <div class=" video-action-content">
      ...
      <div class="video-action-item" @click="addDianzan" @mouseenter="showLikeBox = true"
        @mouseleave="showLikeBox = false">
        <div class="like-box postion swiper" v-if="showLikeBox">
          <svg width="4" height="17" fill="none" xmlns="http://www.w3.org/2000/svg" class="like-box-icon postion"
            viewBox="0 0 4 17">
            <path d="M0 0a8 8 0 002.168 5.476l1.174 1.25a2 2 0 010 2.738l-1.174 1.25A8 8 0 000 16.19V0z" fill="#323442">
            </path>
          </svg>
      ...
      <div class="video-action-item" @click="$emit('toggleComments')" @mouseenter="showCommentBox = true"
      ...
      <div class="video-action-item" @click="addShoucang" @mouseenter="showCollectionBox = true"
        @mouseleave="showCollectionBox = false">
        <svg-icon class="icon-collect" icon="collection" :class="{ collect: isCollect }" />
            ...
            <div class="collection-box-item">
              <div class="collection-box-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                  class="box-icon-all collection-folder-icon" viewBox="0 0 24 24">
                  <path
                    d="M3 7a2 2 0 012-2h3.338a2 2 0 01.791.163l2.777 1.195a4 4 0 001.582.326H19a2 2 0 012 2V17a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"
                    stroke="#fff" stroke-opacity="0.75" stroke-width="2"></path>
                  <path d="M7 14h9M7 10h2" stroke="#fff" stroke-opacity="0.8" stroke-width="2" stroke-linecap="round">
                  </path>
                </svg>
              </div>
            ...
            <div class="collection-box-item">
              <div class="collection-box-icon">
                <svg width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"
                  class="box-icon-all video-collection" viewBox="0 0 24 24">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    fill="rgba(22, 24, 35, 0.75)" fill-opacity="0.75"></path>
                </svg>
              </div>
      ...
      <div class="video-action-item" @mouseenter="showMoreBox = true" @mouseleave="showMoreBox = false">
        <svg-icon class="icon" icon="more" />
        <div class="more-box" ref="more" :style="{ width: `${width}px`, display: 'flex' }" v-if="showMoreBox">
          <div class="more-box-content">
              ...
              <div class="more-box-icon">
                <svg width="36" height="36" fill="none" xmlns="http://www.w3.org/2000/svg" class="" viewBox="0 0 36 36">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    fill="rgba(22,24,35,.6)" fill-opacity="0.9"></path>
                </svg>
              </div>
            ...
            <div class="more-box-item" v-show="isAttent === 1 || isAttent === 3" @click="handleAttention">
              <div class="more-box-icon">
                <svg width="36" height="36" fill="none" xmlns="http://www.w3.org/2000/svg" class="" viewBox="0 0 36 36">
                  <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="more-box-item">
              <div class="more-box-icon">
                <svg width="36" height="36" fill="none" xmlns="http://www.w3.org/2000/svg" class="kuaijie-icon"
                  viewBox="0 0 36 36">
                  <rect x="6" y="9" width="24" height="18" rx="2" stroke="rgba(22,24,35,.6)" stroke-opacity="0.8"
                    stroke-width="2"></rect>
                  <path stroke="rgba(22,24,35,.6)" stroke-opacity="0.8" stroke-width="2" stroke-linecap="round"
                    d="M11 22h14M11 14h2M17 14h2M23 14h2M23 18h2M17 18h2M11 18h2"></path>
                </svg>
              </div>
          ...
          <div class="more-music-detail" :style="{ maxWidth: `${maXWidth}` }">
                ...
                <div class="more-music-icon">
                  <svg width="36" height="36" fill="none" xmlns="http://www.w3.org/2000/svg" class=""
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      fill="rgba(22, 24, 35, 0.6)" fill-opacity="0.8"></path>
                  </svg>
                  testsss阿萨
                </div>
            ...
            <button type="button" class="favorite-button favorite-label favorite-badge favorite-button-container">
              <svg width="12" height="13" fill="none" xmlns="http://www.w3.org/2000/svg" class="" viewBox="0 0 12 13">
                <path
