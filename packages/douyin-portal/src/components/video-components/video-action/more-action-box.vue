  ...
  <div class="more-box">
    <div class="more-box-content">
      ...
      <div class="more-box-item active" @click="handleRecommend">
        <div class="more-box-icon recommend-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="none" viewBox="0 0 27 27">
            <path d="M18.544 22.86H8.42V9.697l5.821-5.821a1.79 1.79 0 0 1 2.531 0c.118.118.215.278.291.48.076.203.114.397.114.583v.354l-1.114 4.404h5.518c.54 0 1.012.203 1.417.608.405.405.608.877.608 1.417v2.025a2.059 2.059 0 0 1-.152.759l-3.037 7.137c-.152.338-.405.625-.76.861a1.978 1.978 0 0 1-1.113.354zM6.79 9.697V22.86H4.366a1.625 1.625 0 0 1-1.625-1.625v-9.91c0-.898.728-1.626 1.625-1.626h2.425z" fill="#13C15A"></path>
          </svg>
        </div>
      ...
      <div class="more-box-item" @click="handlePhoneContinue">
        <div class="more-box-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path d="M5 4C5 2.89543 5.89543 2 7 2H17C18.1046 2 19 2.89543 19 4V21C19 22.1046 18.1046 23 17 23H7C5.89543 23 5 22.1046 5 21V4ZM7 6V20C7 20.5523 7.44772 21 8 21H16C16.5523 21 17 20.5523 17 20V6C17 5.44772 16.5523 5 16 5H8C7.44772 5 7 5.44772 7 6ZM10.5 3C10.2239 3 10 3.22386 10 3.5C10 3.77614 10.2239 4 10.5 4H13.5C13.7761 4 14 3.77614 14 3.5C14 3.22386 13.7761 3 13.5 3H10.5Z" fill="currentColor"></path>
          </svg>
        </div>
        <div class="more-box-title">手机续播</div>
      </div>
      <!-- 取消关注 -->
      <div class="more-box-item" v-show="isAttent === 1 || isAttent === 3" @click="handleCancelFollow">
        <div class="more-box-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.6 10.857c0-2.409 1.988-4.33 4.4-4.33 2.412 0 4.4 1.921 4.4 4.33V13c0 2.39-1.96 4.3-4.348 4.327h-.104C14.561 17.3 12.6 15.39 12.6 13v-2.143zm4.4-2.53c-1.453 0-2.6 1.15-2.6 2.53V13c0 1.366 1.128 2.508 2.564 2.527h.072C18.472 15.508 19.6 14.366 19.6 13v-2.143c0-1.38-1.148-2.53-2.6-2.53z" fill="currentColor"></path>
            <path d="M21.399 23.23c-.405 0-.732.382-.732.854 0 .471.327.854.732.854h3.66c.405 0 .733-.383.733-.854 0-.472-.328-.854-.732-.854h-3.661z" fill="currentColor"></path>
          </svg>
        </div>
      ...
      <div class="more-box-item" @click="handleReport">
        <div class="more-box-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path d="M12 9C12.5523 9 13 9.44771 13 10V14C13 14.5523 12.5523 15 12 15C11.4477 15 11 14.5523 11 14V10C11 9.44771 11.4477 9 12 9Z" fill="currentColor"></path>
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.7238 3.95825C12.9505 2.64364 11.0494 2.64364 10.2761 3.95825L2.02453 17.9859C1.24025 19.3192 2.20156 21 3.7484 21H20.2516C21.7984 21 22.7597 19.3192 21.9754 17.9859L13.7238 3.95825ZM12 4.97229L20.2516 19H3.7484L12 4.97229Z" fill="currentColor"></path>
          </svg>
        </div>
      ...
      <div class="more-box-item" @click="handleShortcutList">
        <div class="more-box-icon">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path d="M6 8C5.44772 8 5 8.44772 5 9C5 9.55228 5.44772 10 6 10H8C8.55228 10 9 9.55228 9 9C9 8.44772 8.55228 8 8 8H6Z" fill="currentColor"></path>
            <path d="M5 12C5 11.4477 5.44772 11 6 11H8C8.55228 11 9 11.4477 9 12C9 12.5523 8.55228 13 8 13H6C5.44772 13 5 12.5523 5 12Z" fill="currentColor"></path>
            <path d="M6 14C5.44772 14 5 14.4477 5 15C5 15.5523 5.44772 16 6 16H18C18.5523 16 19 15.5523 19 15C19 14.4477 18.5523 14 18 14H6Z" fill="currentColor"></path>
            <path d="M10 9C10 8.44772 10.4477 8 11 8H13C13.5523 8 14 8.44772 14 9C14 9.55228 13.5523 10 13 10H11C10.4477 10 10 9.55228 10 9Z" fill="currentColor"></path>
            <path d="M11 11C10.4477 11 10 11.4477 10 12C10 12.5523 10.4477 13 11 13H13C13.5523 13 14 12.5523 14 12C14 11.4477 13.5523 11 13 11H11Z" fill="currentColor"></path>
            <path d="M15 9C15 8.44772 15.4477 8 16 8H18C18.5523 8 19 8.44772 19 9C19 9.55228 18.5523 10 18 10H16C15.4477 10 15 9.55228 15 9Z" fill="currentColor"></path>
            <path d="M16 11C15.4477 11 15 11.4477 15 12C15 12.5523 15.4477 13 16 13H18C18.5523 13 19 12.5523 19 12C19 11.4477 18.5523 11 18 11H16Z" fill="currentColor"></path>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M4 4C2.89543 4 2 4.89543 2 6V18C2 19.1046 2.89543 20 4 20H20C21.1046 20 22 19.1046 22 18V6C22 4.89543 21.1046 4 20 4H4ZM4 6L20 6V18H4V6Z" fill="currentColor"></path>
          </svg>
        </div>
    ...
    <div class="more-music-detail">
      ...
      <div class="music-actions">
        <!-- 播放按钮 -->
        <button type="button" class="music-action-btn" @click="togglePlayMusic" :title="isPlaying ? '暂停' : '播放'">
          <svg v-if="!isPlaying" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            <path d="M8 5.14v13.72a1 1 0 001.5.86l11-6.86a1 1 0 000-1.72l-11-6.86a1 1 0 00-1.5.86z" fill="currentColor"></path>
          </svg>
          <svg v-else viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            <path d="M8 5a1 1 0 011 1v12a1 1 0 11-2 0V6a1 1 0 011-1zM16 5a1 1 0 011 1v12a1 1 0 11-2 0V6a1 1 0 011-1z" fill="currentColor"></path>
          </svg>
        </button>
        <!-- 下载按钮 -->
        <button type="button" class="music-action-btn" @click="downloadMusic" title="下载">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            <path d="M12 3a1 1 0 011 1v10.586l3.293-3.293a1 1 0 111.414 1.414l-5 5a1 1 0 01-1.414 0l-5-5a1 1 0 111.414-1.414L11 14.586V4a1 1 0 011-1zM5 19a1 1 0 100 2h14a1 1 0 100-2H5z" fill="currentColor"></path>
          </svg>
        </button>
      </div>
      <!-- 收藏按钮 -->
      <button type="button" class="favorite-button" @click="handleCollectMusic">
        <svg width="12" height="13" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 13">
