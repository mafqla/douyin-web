...
watchEffect(() => {
  if (show.value) {
    ...
    // 初始化表单数据
    if (props.folder) {
      folderName.value = props.folder.collects_name
      isPrivate.value = props.folder.status === 1
    }
  } else {
...
const handleSubmit = async () => {
  ...
  try {
    // TODO: 调用编辑收藏夹接口
    // await apis.updateCollectFolder({
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <div class="btn-content">
            <button class="cancel common" @click="close">取消</button>
            <button
              class="save common"
