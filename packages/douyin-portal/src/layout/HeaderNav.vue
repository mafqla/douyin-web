      ...
      <div class="header-content">
        ...
        <div class="header-right">
          ...
          <template v-else>
            ...
            <el-dialog v-model="dialogTableVisible" title="登录后免费畅享高清视频" align-center center :append-to-body="true"
              :destroy-on-close="true" class="login-pannel">
  ...
  .header-main {
    ...
    .header-content {
      ...
      @media (min-width: 1320px) {
        .header-left {
          left: calc(50vw - var(--navigation-expend-width) / 2 - 34px - (100% + 32px + var(--navigation-expend-width)) * 0.278 / 2);
