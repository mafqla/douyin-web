    ...
    <div class="exit-btn">
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M15.922 4.744a.833.833 0 00-1.178 0l-6.667 6.667a.833.833 0 000 1.178l6.667 6.667a.833.833 0 101.178-1.179L9.845 12l6.077-6.077a.833.833 0 000-1.179z"
          fill="currentColor"
          fill-opacity="0.9"
        ></path>
      </svg>
