const i18n = {
  'en-US': {
    'login.form.title': 'Login to douyin admin',
    'login.form.userName.errMsg': 'Cellphone cannot be empty',
    'login.form.password.errMsg': 'Password cannot be empty',
    'login.form.login.errMsg': 'Login error, please refresh and try again',
    'login.form.userName.placeholder': ' Cellphone ',
  ...
  'zh-CN': {
    'login.form.title': '登录抖音内容管理后台',
    'login.form.userName.errMsg': '手机号码不能为空',
    'login.form.password.errMsg': '密码不能为空',
    'login.form.login.errMsg': '登录出错，请刷新重试',
    'login.form.userName.placeholder': '手机号码',
